...
export default function Gallery(props: Props) {
  ...
  const mobileItemLayout = (index: number) => {
    const mobileBigImageIndex = Math.floor(index / 3) % 2 === 0 ? 0 : 2;

    return index % 3 === mobileBigImageIndex
  ...
  return (
    <section class="container px-4 py-8 flex flex-col gap-8 lg:gap-10 lg:py-10 lg:px-0">
      ...
      />
      <ul class="grid grid-cols-2 md:grid-cols-3 grid-rows-6 gap-4 list-none">
